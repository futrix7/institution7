...
import { GraduationCap, Mail, ArrowLeft, Send, Loader2, CheckCircle2, AlertCircle } from "lucide-react"
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const { error } = await supabase.auth.resetPasswordForEmail(email, {
        redirectTo: `${window.location.origin}/auth/user/update-password`,
      })
